...
export default function InvoicesPage() {
  ...
  const updateFilter = (field: keyof InvoiceFilters, value: string) => {
    setFilters((previous) => ({
      ...previous,
      [field]: value,
    }));
  ...
  const columns = [
    ...
    },
    {
      ...
      label: "Montant",
      render: (item: Invoice) => `${item.totalAmount.toLocaleString()} €`,
    },
  ];
        ...
        <div className="filters-content">
          ...
          <div className="filter-item">
            <Select
              ...
              onChange={(event) =>
                updateFilter("invoiceType", event.target.value)
              }
              options={[
                {
                  value: "",
          ...
          <div className="filter-item">
            <TextInput
              ...
              onChange={(event) =>
                updateFilter("customerName", event.target.value)
              }
            />
          </div>
