...
export default function NewOliveAnalysisPage() {
    ...
    const {
        ...
        error,
    } = useCreateOliveAnalysis()

    const [form, setForm] =
        useState<NewOliveAnalysisForm>(initialForm)
    ...
    const handleSubmit = useCallback(
        async () => {
            ...
            try {
                ...
                const success =
                    await createOliveAnalysisAction(
                        request,
                    )

                if (success) {
                    toast.success(
                        "Analyse d'olive créée avec succès.",
                    )
                ...
                toast.error(
                    "Une erreur est survenue lors de la création de l'analyse.",
                )
            ...
            <div className="page-header">
                <div className="page-header-content">
                    ...
                    <h1 className="page-title">
                        Nouvelle analyse d'olive
                    </h1>

                    <p className="page-description">
                        Créer une nouvelle analyse d'olive et
                        renseigner les résultats de contrôle.
                    </p>
            ...
            <div className="filters">
                ...
                <div className="filters-header">
                    <div>
                        ...
                        <span>
                            Sélectionnez la source sur laquelle
